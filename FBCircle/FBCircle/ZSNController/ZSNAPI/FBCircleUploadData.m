...
-(void)uploadForwards:(id)data
{
    ...
    NSString * fullUrl = [NSString stringWithFormat:FBCIRCLE_FORWARD_URL,[SzkAPI getAuthkey],model.comment_tid,model.comment_uid,[model.comment_content stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
...
-(void)uploadComments:(id)data
{
    ...
    NSString * fullUrl = [NSString stringWithFormat:FBCIRCLE_COMMENT_URL,[SzkAPI getAuthkey],model.comment_tid,model.comment_uid,[model.comment_content stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
...
-(void)uploadBlogWith:(FBCircleModel *)model
{
    ...
    }else
    {
        ...
        {
            fullUrl = [NSString stringWithFormat:PUBLISH_TEXT_LOCATION,model.fb_authkey,[model.fb_content stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],[model.fb_lng floatValue],[model.fb_lat floatValue],[model.fb_area stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
        }else
        {
            fullUrl = [NSString stringWithFormat:PUBLISH_TEXT,model.fb_authkey,[model.fb_content stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
        }
...
-(void)sendBlogWithArray:(NSArray *)array WithModel:(FBCircleModel *)model
{
    ...
    if (model.fb_area.length > 0)
    {
        fullUrl = [NSString stringWithFormat:PUBLISH_IMAGE_TEXT_LOCATION,model.fb_authkey,[model.fb_content stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]
    ...
    {
        fullUrl = [NSString stringWithFormat:PUBLISH_IMAGE_TEXT,model.fb_authkey,[model.fb_content stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],[[NSString stringWithFormat:@"%@",authod] stringByAddingPercentEscapesUsingEncoding:  NSUTF8StringEncoding]];
